# <a name="microsoft-graph-ios-swift-snippets-sample"></a>Пример фрагментов кода Microsoft Graph на Swift для iOS
...
* [Xcode](https://developer.apple.com/xcode/downloads/) версии 7.3.1 от Apple 
...
Весь код для проверки подлинности можно найти в файле **Authentication.swift**. Мы используем протокол MSAuthenticationProvider из файла NXOAuth2Client для поддержки входа в зарегистрированных собственных приложениях, автоматического обновления токенов доступа и выхода. Идентификатор клиента и разрешения, используемые в этом примере, определены в файле **ApplicationConstants.swift**.

Все фрагменты кода расположены в разделе **Graph-iOS-Swift-Snippets/Snippets** в навигаторе проекта.
...
Фрагменты кода, которые можно выполнять в учетных записях администратора, организации и личных учетных записях, см. в файлах UserSnippets.swift и GroupsSnippets.swift в разделе Graph-iOS-Swift-Snippets/Snippets в навигаторе проекта. В каждом описании фрагмента кода указывается уровень доступа.
